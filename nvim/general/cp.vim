...
command! -nargs=0 CompileAndRun call TermWrapper(printf('g++ -std=c++14 -Wall -O2 %s && ./a.out', expand('%')))
command! -nargs=1 CompileAndRunWithFile call TermWrapper(printf('g++ -std=c++14 -Wall -O2 %s && ./a.out < %s', expand('%'), <args>))
autocmd FileType cpp map <F9> :CompileAndRun<CR>
...
let g:split_term_resize_cmd = 'resize 48'
